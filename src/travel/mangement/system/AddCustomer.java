...
AddCustomer(String username){
	setBounds (300, 80, 870, 625);
        ...
        comboid= new JComboBox (new String[] {"Passport","CNIC","License card","Service card"});
        ...
        rfemale.setBounds(330, 210, 70, 25);
...
try{
    Conn c = new Conn();
   var rs = c.s.executeQuery("SELECT username, name FROM account WHERE username = '" + username + "'");
